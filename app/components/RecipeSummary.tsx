const RecipeSummary = () => {
  return (
    <div className=" h-20 w-full bg-gray-100 rounded-md   flex justify-start border border-gray-200 items-center  px-4 hover:bg-gray-200 hover:bg-opacity-40 dark:bg-neutral-900 dark:border-neutral-800">

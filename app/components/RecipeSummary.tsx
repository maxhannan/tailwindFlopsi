const RecipeSummary = () => {
  return (
    <div className=" h-20 w-full bg-gray-50 rounded-md  flex justify-start border border-gray-200 items-center px-4 hover:bg-gray-200 hover:bg-opacity-40 dark:bg-gray-800 dark:border-gray-600">
